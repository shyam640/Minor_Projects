...
def takeCommand():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print(f"User Voice Input :{statement}\n")
...
print("Loading your AI personal assistant Thursday")
speak("Thursday Booting Up !")
wishMe()
...
if __name__ =='__main__':
    ...
    while True:
        ...
        if "good bye" in statement or "ok bye" in statement or "stop" in statement or "shutdown" in statement or "see you later" in statement:
            speak('Thursday is shutting down')
            print('Thursday is shutting down,Good bye')
            break
